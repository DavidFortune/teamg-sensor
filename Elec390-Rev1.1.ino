...
HTTPClient http;
    http.begin("https://us-central1-coen-390-team-g.cloudfunctions.net/api/sensor/z1QgZ1bVjYnUyrszlU9b/data");
    http.addHeader("Content-Type", "application/json");
    
    StaticJsonDocument<200> tempDocument;
    tempDocument["rawTemp"] = temperature;
    tempDocument["rawHumidity"] = humidity;
    tempDocument["rawSoilValue"] = rawSoilMoistureValue;
    tempDocument["rawSolarValue"] = rawSolarValue;
    char buffer[200];
